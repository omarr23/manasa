    ...
    <section>
        ...
        >
            <div
                ...
                id="kt_center_details_view"
            >
                <div class="card-header cursor-pointer">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">
                            {{filters.ConvertCamelToTitleName($t('center._title')) }} {{$t('center.details') }}
                        </h3>
                    </div>
                    <!--end::Card title-->
                    <div>
                        ...
                        >
                            <div class="menu-item px-5">
                                <router-link
                                    :to="{ name: 'center-edit', params: { id: viewData?.id } }"
                                    class="menu-link align-self-center"
                                    v-if="can('update', 'center')"
                                    >
                                    {{ $t('action.edit') }}
                                </router-link>
                            </div>
...
import type { center } from '@/providers/center'
import * as  centerProvider_  from '@/providers/center'
import {relations} from '@/providers/center'
...
const viewData = ref<center|null>();
...
const submitDelete = async () => {
    ...
    if (confirmed.isConfirmed) {
        try {
            ...
            Swal.fire({
                text: 'An error occurred while deleting the center',
                icon: 'error',
                buttonsStyling: false,
                confirmButtonText: 'Ok, got it!',
                heightAuto: false,
