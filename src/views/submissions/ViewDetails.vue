    ...
    <section>
        ...
        >
            <div
                ...
                id="kt_submissions_details_view"
            >
                <div class="card-header cursor-pointer">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">
                            {{filters.ConvertCamelToTitleName($t('submissions._title')) }} {{$t('submissions.details') }}
                        </h3>
                    </div>
                    <!--end::Card title-->
                    <div>
                        ...
                        >
                            <div class="menu-item px-5">
                                <router-link
                                    :to="{ name: 'submissions-edit', params: { id: viewData?.id } }"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <!-- modifiedAt -->
                                        <info-item
                                            :label="$t('submissions.modifiedAt')"
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('submissions.submissionsExam')"
                                            :data="viewData.submissionsExam"
                                            type="hasOne"
                                            displayName="name"
                                        />
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('submissions.businessUnit')"
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('submissions.modifiedBy')"
...
import type { submissions } from '@/providers/submissions'
import * as  submissionsProvider_  from '@/providers/submissions'
import {relations} from '@/providers/submissions'
...
const viewData = ref<submissions|null>();
...
const submitDelete = async () => {
    ...
    if (confirmed.isConfirmed) {
        try {
            ...
            Swal.fire({
                text: 'An error occurred while deleting the submissions',
                icon: 'error',
                buttonsStyling: false,
                confirmButtonText: 'Ok, got it!',
                heightAuto: false,
