  ...
  <TableCardHeader
    ...
    <div class="card">
        <div class="card-body table-div">
                ...
                <template v-slot:password="{ row: data }">
                    <info-item-table :data="data.password" type="password"/>
                </template>
                <template v-slot:role="{ row: data }">
                    <info-item-table :data="data.role" type="role"/>
                </template>
                <template v-slot:provider="{ row: data }">
                    <info-item-table :data="data.provider" type="string"/>
                </template>
                ...
                <template v-slot:userBusinessUnit="{ row: data }">
                  <info-item-table :data="data.userBusinessUnit" type="hasOne" displayName="code" />
                </template>
                ...
                <template v-slot:actions="{ row: data, index }">
                    <div class="text-end">
                        <router-link
                          ...
                          :to="{ name: 'user-view', params: { id: data.id } }"
                          v-if="can('view', 'user')"
                          >
...
/* Providers */
import {tableHeader, filterFields, filterFormData} from '@/providers/user';
