    ...
    <section>
        ...
        >
            <div
                ...
                id="kt_businessUnit_details_view"
            >
                <div class="card-header cursor-pointer">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">
                            {{filters.ConvertCamelToTitleName($t('businessUnit._title')) }} {{$t('businessUnit.details') }}
                        </h3>
                    </div>
                    <!--end::Card title-->
                    <div>
                        ...
                        >
                            <div class="menu-item px-5">
                                <router-link
                                    :to="{ name: 'businessUnit-edit', params: { id: viewData?.id } }"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <!-- createdAt -->
                                        <info-item
                                            :label="$t('businessUnit.createdAt')"
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <!-- modifiedAt -->
                                        <info-item
                                            :label="$t('businessUnit.modifiedAt')"
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('businessUnit.parent')"
                                            :data="viewData.parent"
                                            type="hasOne"
                                            displayName="code"
                                        />
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('businessUnit.createdBy')"
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <info-item
                                            :label="$t('businessUnit.modifiedBy')"
...
import type { businessUnit } from '@/providers/businessUnit'
import * as  businessUnitProvider_  from '@/providers/businessUnit'
import {relations} from '@/providers/businessUnit'
...
const viewData = ref<businessUnit|null>();
    ...
    if (confirmed.isConfirmed) {
        try {
            await store
                ...
                .then(() => {
                    router.push({ name: 'businessUnit-list' });
                    Swal.fire({
            ...
            Swal.fire({
                text: 'An error occurred while deleting the businessUnit',
                icon: 'error',
                buttonsStyling: false,
                confirmButtonText: 'Ok, got it!',
                heightAuto: false,
