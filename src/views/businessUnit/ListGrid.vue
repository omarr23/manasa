    ...
    <div class="card">
        <div class="card-body table-div">
                ...
                <template v-slot:code="{ row: data }">
                    <info-item-table :data="data.code" type="string"/>
                </template>
                ...
                <template v-slot:parent="{ row: data }">
                  <info-item-table :data="data.parent" type="hasOne" displayName="code" />
                </template>
                ...
                <template v-slot:actions="{ row: data, index }">
                    <div class="text-end">
                        <router-link
                          ...
                          :to="{ name: 'businessUnit-view', params: { id: data.id } }"
                          v-if="can('view', 'businessUnit')"
                          >
                        ...
                        <router-link
                          class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                          :to="{ name: 'businessUnit-edit',params: { id: data.id }}"
...
/* Providers */
import {tableHeader, filterFields, filterFormData} from '@/providers/businessUnit';
