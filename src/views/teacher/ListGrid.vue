  ...
  <TableCardHeader
    ...
    <div class="card">
        <div class="card-body table-div">
                ...
                <template v-slot:teacherCenter="{ row: data }">
                  <info-item-table :data="data.teacherCenter" type="hasOne" displayName="name" />
                </template>
                <template v-slot:teacheruser="{ row: data }">
                  <info-item-table :data="data.teacheruser" type="hasOne" displayName="email" />
                </template>
                ...
                <template v-slot:actions="{ row: data, index }">
                    <div class="text-end">
                        <router-link
                          ...
                          :to="{ name: 'teacher-view', params: { id: data.id } }"
                          v-if="can('view', 'teacher')"
                          >
                        ...
                        <router-link
                          class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                          :to="{ name: 'teacher-edit',params: { id: data.id }}"
...
/* Providers */
import {tableHeader, filterFields, filterFormData} from '@/providers/teacher';
