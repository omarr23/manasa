...
import { formData, formFields, defaultFormFields } from "@/providers/exam";
  ...
  resetConstraints
    ...
    const id = ref(router.currentRoute.value.params.id);
     ...
     const handleSubmit = async () => {
      ...
      const res = await examEntity.update(id.value.toString(), data)
      if (res) {
        Swal.fire({
    ...
    onMounted(async () => {
      examItem.value = await examEntity.fetchItemAsync(id.value)
