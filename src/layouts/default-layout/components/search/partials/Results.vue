    ...
    <div>
        ...
        <div class="scroll-y mh-200px mh-lg-325px">
            ...
            >
                ...
                <div class="symbol symbol-40px symbol-circle me-4">
                    <img
                        :src="getAssetPath('media/avatars/300-14.jpg')"
                        alt=""
                    />
                </div>
                <!--end::Symbol-->
                ...
                <div class="symbol symbol-40px symbol-circle me-4">
                    <span class="symbol-label bg-light">
                        <img
                            class="w-20px h-20px"
                            :src="
                                getAssetPath('media/svg/brand-logos/tvit.svg')
                            "
                            alt=""
                        />
                    </span>
                ...
                <div class="symbol symbol-40px symbol-circle me-4">
                    <span class="symbol-label bg-light">
                        <img
                            class="w-20px h-20px"
                            :src="
                                getAssetPath('media/svg/brand-logos/leaf.svg')
                            "
                            alt=""
                        />
                    </span>
                ...
                <div class="symbol symbol-40px symbol-circle me-4">
                    <span class="symbol-label bg-light">
                        <img
                            class="w-20px h-20px"
                            :src="
                                getAssetPath('media/svg/brand-logos/tower.svg')
                            "
                            alt=""
                        />
                    </span>
